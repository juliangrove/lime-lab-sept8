...
#+beamer_header: \definecolor{gb-orange}{HTML}{d65d0e}
#+beamer_header: \newtcbox{\purebox}{nobeforeafter,tcbox raise base,boxrule=0.5pt,top=0mm,bottom=0mm,left=0mm,right=0mm,arc=3pt,boxsep=2pt,colframe=gb-orange,colback=white}
